        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton("New Movies", url="https://t.me/mrkpmovies"),
                        InlineKeyboardButton("Movie Request", url="https://t.me/mrkprequest")
                    ],
                    [
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == "private":
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support Group](https://t.me/mrkphelp)",
                                     disable_web_page_preview=True)
            return
        ...
        try:
            ...
            share_link = f"https://t.me/{Config.BOT_USERNAME}?start=rajeshsaini2115_{str_to_b64(file_er_id)}"
        ...
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton("Go Home🏘️", callback_data="gotohome"),
                        InlineKeyboardButton("About Dev👩‍💻", callback_data="aboutdevs"),
                    ]
                ]
            )
